...
export default function ExportPlaybook() {
  ...
  const handleCopy = () => {
    const text = JSON.stringify(playbook, null, 2);
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white text-xl font-bold">Production Playbook Export</h1>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 mb-6">
          <div className="border-b border-slate-800 pb-4 mb-4">
            ...
            <p className="text-slate-500 text-sm mt-1">Production Playbook — Confidential</p>
          </div>
        ...
        <div className="border-t border-slate-800 pt-4 mt-4 text-xs text-slate-700 flex justify-between">
          <span>Generated by Production Playbook Builder</span>
